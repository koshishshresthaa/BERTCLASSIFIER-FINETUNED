...
model_path = '../MODEL/fine_tuned_patrakar_model/fine_tuned_patrakar_model'
tokenizer = AutoTokenizer.from_pretrained(model_path)
model = AutoModelForSequenceClassification.from_pretrained(model_path)

file_path_stopwords = "../DATA/nepali_stopwords.txt"
file_path_punctuation = "../DATA/nepali_punctuation.txt"
#opening stopwords
with open(file_path_stopwords, "r", encoding="utf-8") as file:
    stop_words = file.readlines()
stop_words = [line.strip() for line in stop_words]

#opening punctuation
with open(file_path_punctuation, "r", encoding="utf-8") as file:
